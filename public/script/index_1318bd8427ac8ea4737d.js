...
/* WEBPACK VAR INJECTION */(function($, baidu) {__webpack_require__(5);
window.$ = $;
...
module.exports = "<li class=\"index-item-outline <%if(top){%>istop<%}%>\">\n    \n    <%if(!top){%><div class=\"index-line\"></div><%}%>\n    <div class=\"index-item\">\n            <h3 class=\"title\"><%=data.title%></h3>\n            <h5 class=\"subtitle\"><%=data.subtitle%></h5>\n            <p class=\"content\"><%=data.content%></p>\n    </div>\n    <%if(top){%><div class=\"index-line\"></div><%}%>\n</li>";
...
;(function(){
    ...
    var baidu =  false ? (this.baidu = this.baidu || {}) : module.exports;
